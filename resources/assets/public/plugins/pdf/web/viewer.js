...
PDFJS.imageResourcesPath = URL_PLUGIN + 'web/images/';
PDFJS.workerSrc = URL_PLUGIN + 'build/pdf.worker.js';
PDFJS.cMapUrl = URL_PLUGIN + 'web/cmaps/';
...
function PDFPageView(options) {
    ...
    div.className = 'page';
	var cssWidth = Math.floor(this.viewport.width) + 'px';
	var cssHeight = Math.floor(this.viewport.height) + 'px';
